...
This class implements a data structure for easy and readable saving of vectors. It overloads the methods for summation, multiplication and comparison of vectors. It furthermore implements a method for calculation of the L2-\/norm and simplifies the access to vector components by using {\ttfamily \mbox{[}} and {\ttfamily \mbox{]}} brackets.
