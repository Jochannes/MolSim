...
Particle::Particle(int type_arg) :
		f(0.0), old_f(0.0), m(0.0), type(type_arg) {
...
Particle::Particle(const Particle& other) :
		x(other.x), v(other.v), f(other.f), old_f(other.old_f), m(other.m), type(
				other.type) {
...
Particle::Particle(utils::Vector<double, 3> x_arg,
		...
		x(x_arg), v(v_arg), m(m_arg), type(type_arg), f(0.0), old_f(0.0) {
	LOG4CXX_TRACE(Particlelogger, "Particle generated!");
}
