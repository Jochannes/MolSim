...
DataArrayList_t::DataArrayList_t(const DataArrayList_t& o,
		...
		::xml_schema::simple_type(o, f, c), ::xsd::cxx::tree::list<
				::xml_schema::decimal, char,
				::xsd::cxx::tree::schema_type::decimal>(o, f, this) {
}
...
void DataArray_t::type(::std::auto_ptr<type_type> x) {
	this->type_.set(x);
}
...
void DataArray_t::Name(::std::auto_ptr<Name_type> x) {
	this->Name_.set(x);
}
...
void PieceUnstructuredGrid_t::PointData(::std::auto_ptr<PointData_type> x) {
	this->PointData_.set(x);
}
...
void PieceUnstructuredGrid_t::CellData(::std::auto_ptr<CellData_type> x) {
	this->CellData_.set(x);
}
...
void PieceUnstructuredGrid_t::Points(::std::auto_ptr<Points_type> x) {
	this->Points_.set(x);
}
...
void PieceUnstructuredGrid_t::Cells(::std::auto_ptr<Cells_type> x) {
	this->Cells_.set(x);
}
...
void UnstructuredGrid_t::Piece(::std::auto_ptr<Piece_type> x) {
	this->Piece_.set(x);
}
...
void PolyData_t::greeting(::std::auto_ptr<greeting_type> x) {
	this->greeting_.set(x);
}
...
void VTKFile_t::UnstructuredGrid(::std::auto_ptr<UnstructuredGrid_type> x) {
	this->UnstructuredGrid_.set(x);
}
...
void VTKFile_t::PolyData(::std::auto_ptr<PolyData_type> x) {
	this->PolyData_.set(x);
}
...
void VTKFile_t::type(::std::auto_ptr<type_type> x) {
	this->type_.set(x);
}
...
DataArrayList_t::DataArrayList_t(const ::xercesc::DOMElement& e,
		::xml_schema::flags f, ::xml_schema::container* c) :
		::xml_schema::simple_type(e, f, c), ::xsd::cxx::tree::list<
				::xml_schema::decimal, char,
...
DataArrayList_t::DataArrayList_t(const ::xercesc::DOMAttr& a,
		::xml_schema::flags f, ::xml_schema::container* c) :
		::xml_schema::simple_type(a, f, c), ::xsd::cxx::tree::list<
				::xml_schema::decimal, char,
				::xsd::cxx::tree::schema_type::decimal>(a, f, this) {
}

DataArrayList_t::DataArrayList_t(const ::std::string& s,
		const ::xercesc::DOMElement* e, ::xml_schema::flags f,
		::xml_schema::container* c) :
		::xml_schema::simple_type(s, e, f, c), ::xsd::cxx::tree::list<
				::xml_schema::decimal, char,
				::xsd::cxx::tree::schema_type::decimal>(s, e, f, this) {
}
...
DataArray_t::DataArray_t(const type_type& type, const Name_type& Name,
		...
		::DataArrayList_t(), type_(type, ::xml_schema::flags(), this), Name_(
				Name, ::xml_schema::flags(), this), NumberOfComponents_(
				NumberOfComponents, ::xml_schema::flags(), this), format_(
				format_default_value(), ::xml_schema::flags(), this), offset_(
...
DataArray_t::DataArray_t(const ::DataArrayList_t& _xsd_DataArrayList_t_base,
		...
		const NumberOfComponents_type& NumberOfComponents) :
		::DataArrayList_t(_xsd_DataArrayList_t_base), type_(type,
				::xml_schema::flags(), this), Name_(Name, ::xml_schema::flags(),
				this), NumberOfComponents_(NumberOfComponents,
				::xml_schema::flags(), this), format_(format_default_value(),
				::xml_schema::flags(), this), offset_(::xml_schema::flags(),
				this) {
}

DataArray_t::DataArray_t(const DataArray_t& x, ::xml_schema::flags f,
		::xml_schema::container* c) :
		::DataArrayList_t(x, f, c), type_(x.type_, f, this), Name_(x.Name_, f,
				this), NumberOfComponents_(x.NumberOfComponents_, f, this), format_(
				x.format_, f, this), offset_(x.offset_, f, this) {
}

DataArray_t::DataArray_t(const ::xercesc::DOMElement& e, ::xml_schema::flags f,
		::xml_schema::container* c) :
		::DataArrayList_t(e, f | ::xml_schema::flags::base, c), type_(f, this), Name_(
				f, this), NumberOfComponents_(f, this), format_(f, this), offset_(
				f, this) {
...
void DataArray_t::parse(::xsd::cxx::xml::dom::parser<char>& p,
	...
	while (p.more_attributes()) {
		...
		if (n.name() == "type" && n.namespace_().empty()) {
			::std::auto_ptr<type_type> r(type_traits::create(i, f, this));
		...
		if (n.name() == "format" && n.namespace_().empty()) {
			::std::auto_ptr<format_type> r(format_traits::create(i, f, this));
...
PieceUnstructuredGrid_t::PieceUnstructuredGrid_t(
		...
		::xml_schema::type(), PointData_(PointData, ::xml_schema::flags(),
				this), CellData_(CellData, ::xml_schema::flags(), this), Points_(
				Points, ::xml_schema::flags(), this), Cells_(Cells,
				::xml_schema::flags(), this), NumberOfPoints_(NumberOfPoints,
				::xml_schema::flags(), this), NumberOfCells_(NumberOfCells,
				::xml_schema::flags(), this) {
}

PieceUnstructuredGrid_t::PieceUnstructuredGrid_t(
		::std::auto_ptr<PointData_type>& PointData,
...
PieceUnstructuredGrid_t::PieceUnstructuredGrid_t(
		...
		::xml_schema::container* c) :
		::xml_schema::type(x, f, c), PointData_(x.PointData_, f, this), CellData_(
				x.CellData_, f, this), Points_(x.Points_, f, this), Cells_(
				x.Cells_, f, this), NumberOfPoints_(x.NumberOfPoints_, f, this), NumberOfCells_(
				x.NumberOfCells_, f, this) {
}

PieceUnstructuredGrid_t::PieceUnstructuredGrid_t(const ::xercesc::DOMElement& e,
		::xml_schema::flags f, ::xml_schema::container* c) :
		::xml_schema::type(e, f | ::xml_schema::flags::base, c), PointData_(f,
				this), CellData_(f, this), Points_(f, this), Cells_(f, this), NumberOfPoints_(
				f, this), NumberOfCells_(f, this) {
	if ((f & ::xml_schema::flags::base) == 0) {
...
void PieceUnstructuredGrid_t::parse(::xsd::cxx::xml::dom::parser<char>& p,
	...
	for (; p.more_elements(); p.next_element()) {
		...
		if (n.name() == "Points" && n.namespace_().empty()) {
			::std::auto_ptr<Points_type> r(Points_traits::create(i, f, this));
		...
		if (n.name() == "Cells" && n.namespace_().empty()) {
			::std::auto_ptr<Cells_type> r(Cells_traits::create(i, f, this));
...
PieceUnstructuredGrid_t* PieceUnstructuredGrid_t::_clone(::xml_schema::flags f,
		::xml_schema::container* c) const {
...
UnstructuredGrid_t::UnstructuredGrid_t(const Piece_type& Piece) :
		::xml_schema::type(), Piece_(Piece, ::xml_schema::flags(), this) {
}

UnstructuredGrid_t::UnstructuredGrid_t(::std::auto_ptr<Piece_type>& Piece) :
		::xml_schema::type(), Piece_(Piece, ::xml_schema::flags(), this) {
}
...
UnstructuredGrid_t::UnstructuredGrid_t(const ::xercesc::DOMElement& e,
		::xml_schema::flags f, ::xml_schema::container* c) :
		::xml_schema::type(e, f | ::xml_schema::flags::base, c), Piece_(f, this) {
	if ((f & ::xml_schema::flags::base) == 0) {
...
void UnstructuredGrid_t::parse(::xsd::cxx::xml::dom::parser<char>& p,
	...
	for (; p.more_elements(); p.next_element()) {
		...
		if (n.name() == "Piece" && n.namespace_().empty()) {
			::std::auto_ptr<Piece_type> r(Piece_traits::create(i, f, this));
...
UnstructuredGrid_t* UnstructuredGrid_t::_clone(::xml_schema::flags f,
		::xml_schema::container* c) const {
...
PolyData_t::PolyData_t(const greeting_type& greeting) :
		::xml_schema::type(), greeting_(greeting, ::xml_schema::flags(), this) {
}
...
PolyData_t::PolyData_t(const ::xercesc::DOMElement& e, ::xml_schema::flags f,
		::xml_schema::container* c) :
		::xml_schema::type(e, f | ::xml_schema::flags::base, c), greeting_(f,
				this) {
	if ((f & ::xml_schema::flags::base) == 0) {
		::xsd::cxx::xml::dom::parser<char> p(e, true, false);
		this->parse(p, f);
...
VTKFile_t::VTKFile_t(const type_type& type) :
		::xml_schema::type(), UnstructuredGrid_(::xml_schema::flags(), this), PolyData_(
				::xml_schema::flags(), this), type_(type, ::xml_schema::flags(),
				this), version_(version_default_value(), ::xml_schema::flags(),
				this), byte_order_(byte_order_default_value(),
				::xml_schema::flags(), this) {
}

VTKFile_t::VTKFile_t(const VTKFile_t& x, ::xml_schema::flags f,
		::xml_schema::container* c) :
		::xml_schema::type(x, f, c), UnstructuredGrid_(x.UnstructuredGrid_, f,
				this), PolyData_(x.PolyData_, f, this), type_(x.type_, f, this), version_(
				x.version_, f, this), byte_order_(x.byte_order_, f, this) {
}

VTKFile_t::VTKFile_t(const ::xercesc::DOMElement& e, ::xml_schema::flags f,
		::xml_schema::container* c) :
		::xml_schema::type(e, f | ::xml_schema::flags::base, c), UnstructuredGrid_(
				f, this), PolyData_(f, this), type_(f, this), version_(f, this), byte_order_(
				f, this) {
	if ((f & ::xml_schema::flags::base) == 0) {
		::xsd::cxx::xml::dom::parser<char> p(e, true, true);
		this->parse(p, f);
...
void VTKFile_t::parse(::xsd::cxx::xml::dom::parser<char>& p,
	...
	while (p.more_attributes()) {
		...
		if (n.name() == "version" && n.namespace_().empty()) {
			::std::auto_ptr<version_type> r(version_traits::create(i, f, this));
...
type::value type::_xsd_type_convert() const {
	...
	const value* i(
			::std::lower_bound(_xsd_type_indexes_, _xsd_type_indexes_ + 10,
					*this, c));
...
const char* const type::_xsd_type_literals_[10] = { "Int8", "UInt8", "Int16",
		"UInt16", "Int32", "UInt32", "Int64", "UInt64", "Float32", "Float64" };

const type::value type::_xsd_type_indexes_[10] = { ::type::Float32,
		::type::Float64, ::type::Int16, ::type::Int32, ::type::Int64,
		::type::Int8, ::type::UInt16, ::type::UInt32, ::type::UInt64,
		::type::UInt8 };
...
PointData::PointData() :
		::xml_schema::type(), DataArray_(::xml_schema::flags(), this) {
}
...
PointData::PointData(const ::xercesc::DOMElement& e, ::xml_schema::flags f,
		::xml_schema::container* c) :
		::xml_schema::type(e, f | ::xml_schema::flags::base, c), DataArray_(f,
				this) {
	if ((f & ::xml_schema::flags::base) == 0) {
		::xsd::cxx::xml::dom::parser<char> p(e, true, false);
		this->parse(p, f);
...
void operator<<(::xercesc::DOMElement& e, const DataArray_t& i) {
	...
	{
		::xercesc::DOMAttr& a(
				::xsd::cxx::xml::dom::create_attribute("NumberOfComponents",
						e));
...
void VTKFile(::xercesc::DOMDocument& d, const ::VTKFile_t& s,
	...
	if (n.name() == "VTKFile" && n.namespace_() == "") {
		...
		throw ::xsd::cxx::tree::unexpected_element<char>(n.name(),
				n.namespace_(), "VTKFile", "");
	}
}
...
void operator<<(::xercesc::DOMElement& e, const PointData& i) {
	...
	// DataArray
	//
	for (PointData::DataArray_const_iterator b(i.DataArray().begin()), n(
			i.DataArray().end()); b != n; ++b) {
		::xercesc::DOMElement& s(
...
void operator<<(::xercesc::DOMElement& e, const CellData& i) {
	...
	// DataArray
	//
	for (CellData::DataArray_const_iterator b(i.DataArray().begin()), n(
			i.DataArray().end()); b != n; ++b) {
		::xercesc::DOMElement& s(
				::xsd::cxx::xml::dom::create_element("DataArray", e));
...
void operator<<(::xercesc::DOMElement& e, const Points& i) {
	...
	// DataArray
	//
	for (Points::DataArray_const_iterator b(i.DataArray().begin()), n(
			i.DataArray().end()); b != n; ++b) {
		::xercesc::DOMElement& s(
				::xsd::cxx::xml::dom::create_element("DataArray", e));
...
void operator<<(::xercesc::DOMElement& e, const Cells& i) {
	...
	// DataArray
	//
	for (Cells::DataArray_const_iterator b(i.DataArray().begin()), n(
			i.DataArray().end()); b != n; ++b) {
		::xercesc::DOMElement& s(
				::xsd::cxx::xml::dom::create_element("DataArray", e));
