...
export CPLUS_INCLUDE_PATH=/scratch/t1221/t1221af/papi-5.4.0/src:$CPLUS_INCLUDE_PATH
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/scratch/t1221/t1221af/papi-5.4.0/src/
